...
When deploying the static build artifacts from `dist/` to production hosting (such as Vercel, Netlify, Nginx, or AWS CloudFront), enforce the following HTTP security headers:
